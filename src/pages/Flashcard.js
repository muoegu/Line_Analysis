  ...
  render() {
    return (
      <div className="App">
        ...
        <textarea onChange={this.findSentiment.bind(this)} />
        <p>Sentiment Score: {this.state.sentimentScore.bind(this)}</p>
        <p>General Sentiment: {this.state.generalSentiment.bind(this)}</p>
      </div>
    );
  }
}
